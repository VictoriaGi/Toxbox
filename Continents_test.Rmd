...
test <- medcon %>%
  ...
  filter(str_detect(Species, "Aphanocapsa")) %>% 
  mutate(yesno = 1) %>%
  distinct %>%
...
ggplot(head(main_toxin_producers_MED,9), aes(x = reorder(Species, -Number_of_records), y = Number_of_records, fill = Species)) + geom_bar(stat = "identity") + 
  ...
  theme(panel.grid.major = element_line(colour = NA), 
    ...
    plot.background = element_rect(linetype = "solid")) + theme(axis.ticks = element_line(colour = "black"), 
    axis.text = element_text(size = 20, colour = "black"), 
    axis.text.x = element_text(size = 14, 
        colour = "black"), axis.text.y = element_text(size = 14, 
        colour = "black"))
ggsave("main_toxin_producers_MED.png")
...
ggplot(head(main_toxin_producers_globally,9), aes(x = reorder(Species, -Number_of_records), y = Number_of_records, fill = Species)) + geom_bar(stat = "identity") + 
  ...
  theme(panel.grid.major = element_line(colour = NA), 
    panel.grid.minor = element_line(colour = NA), 
    panel.background = element_rect(linetype = "solid"), 
    plot.background = element_rect(linetype = "solid")) + theme(axis.text = element_text(size = 14, 
    colour = "black"), axis.text.x = element_text(size = 14, 
    colour = "black"), axis.text.y = element_text(size = 14, 
    colour = "black"))
ggsave("main_toxin_producers_cont.png")
...
ggsave("number_cyanotoxins_cont.png")
```
