...
number_cyanotoxins_cont + scale_fill_manual(values = c("Anatoxin" = "#7fc97f", 
                               "Saxitoxin" = "#beaed4",
                               "Cylindrospermopsin" = "#fdc086",
                               "Microcystin" = "#ffff99",
                               "Nodularin" = "#CC6666"))
...
medcon <- as.matrix(medcon)
head(medcon)

my_group <- as.numeric(substr(rownames(medcon), 1, 1))

heatmap(medcon, scale = "column")
```
